            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-200">
              ...
              <div className="w-full sm:w-auto flex items-center gap-3">
                <button 
                  ...
                  className="w-full sm:w-auto btn-premium px-6 py-2.5 rounded-xl font-bold text-sm text-white cursor-pointer min-h-[44px] flex items-center justify-center gap-2 group"
                >
